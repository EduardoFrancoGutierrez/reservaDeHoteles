...
public class BookingTest {
	...
	public void before(){
		...
		booking = new Booking(1, startDate, endDate, room, client);		
	}
	...
	public void testBookingIntCalendarCalendarRoomClient() {		
		...
		assertEquals(Status.BOOKING, booking.getStatus());
	...
	public void testEqualsObject() {
		...
		assertEquals(booking, new Booking(1, Calendar.getInstance(), cal, room, client));
		cal.add(Calendar.HOUR_OF_DAY, 1);
		assertNotEquals(booking, new Booking(1, Calendar.getInstance(), cal, room, client));
	}
